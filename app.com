{
  ...
  "logo": "https://files.catbox.moe/gld2vo.jpg",
  "keywords": ["MALVIN XD"],
  "success_url": "/",
  ...
  "env": {
    "SESSION_ID": {
      "description": "Put the session-id here.""MALVIN-XD~BopwkBLS#qfFDTXtzdovWW3PB7-iKu-D7Dy9LYp6G2wnshXS3JPE"
      "required": true,
      "value": ""
    },  
    ...
    "MENU_IMG": {
      ...
      "required": false,
      "value": "https://files.catbox.moe/gld2vo.jpg"
    }, 
    
    "ALIVE_IMG": {
      "description": "paste your image url if you don't have you can use this public url.",
      "required": false,
      "value": "https://files.catbox.moe/ktd1l4.jpg"
    }, 
    
    "LIVE_MSG": {
      "description": "paste your alive message hear.",
      "required": false,
      "value": "> ✦ᴍᴀʟᴠɪɴ xᴅ✦ ɪs sᴘᴀʀᴋɪɴɢ ᴀᴄᴛɪᴠᴇ ᴀɴᴅ ᴀʟɪᴠᴇ\n\n\nᴋᴇᴇᴘ ᴜsɪɴɢ ✦ᴍᴀʟᴠɪɴ xᴅ v2✦ ғʀᴏᴍ ɴᴇxᴜs ᴛᴇᴄʜ ɪɴᴄ⚡\n\n\n*© ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ - ᴍᴅ\n\n> ɢɪᴛʜᴜʙ :* github.com/kingmalvn/MALVIN-XD⚡"
    },
    ...
    "STICKER_NAME": {
      "description": "type your sticker pack name.","✦MALVIN-XD✦"
      "required": false,
      "value": "✦MALVIN-XD✦"
    },
    ...
    "AUTO_STATUS_SEEN": {
      "description": "Make it true for automatic status seen.", "true"
      "required": true,
      "value": "true"
     }, 

    "AUTO_STATUS_REACT": {
      "description": "make it true for automatic status reaction or like.", "true"
      "required": true,
      "value": "true"
    }, 
    ...
    "AUTO_STATUS_MSG": {
      ...
      "required": true,
      "value": "*🎉👀Status Seen by malvin xd v2🚀🔥*"
    }, 
    ...
    "ANTI_BAD": {
     ...
     "DESCRIPTION": {
      ...
      "required": false,
      "value": "*> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ ✦ɴᴇxᴜs ᴛᴇᴄʜ✦ ɪɴᴄ✦*"
    },
    ...
    "AUTO_TYPING": {
      ...
      "FAKE_TYPING": {
      "description": "Make it true for fake typing.",
      "required": false,
      "value": "false"
    },
    
    "CURRENT_STATUS": {
      "description": "Make it true for current status.",
      "required": false,
      "value": "false"
    },
    ...
    "OWNER_REACT": {
      "description": "Make it true if you only want react on Owner Massages.",
      "required": false,
      "value": "false"
